...
namespace ZodiacService.Protos {
  public static partial class ZodiacSignTellerAutumn
  {
    ...
    /// <summary>Base class for server-side implementations of ZodiacSignTellerAutumn</summary>
    [grpc::BindServiceMethod(typeof(ZodiacSignTellerAutumn), "BindService")]
    public abstract partial class ZodiacSignTellerAutumnBase
    {
      public virtual global::System.Threading.Tasks.Task<global::ZodiacService.Protos.ZodiacSignAutumn> SayZodiacSign(global::ZodiacService.Protos.DateRequestAutumn request, grpc::ServerCallContext context)
      {
    ...
    public static grpc::ServerServiceDefinition BindService(ZodiacSignTellerAutumnBase serviceImpl)
    {
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    public static void BindService(grpc::ServiceBinderBase serviceBinder, ZodiacSignTellerAutumnBase serviceImpl)
    {
      serviceBinder.AddMethod(__Method_SayZodiacSign, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::ZodiacService.Protos.DateRequestAutumn, global::ZodiacService.Protos.ZodiacSignAutumn>(serviceImpl.SayZodiacSign));
    }
